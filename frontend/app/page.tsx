  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black px-4 pb-20 pt-4 text-white sm:px-6">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-6rem)] max-w-7xl flex-col gap-4">
        <nav className="animate-fade-in flex w-full items-center justify-between rounded-3xl border border-white/10 border-b-white/15 bg-black/55 px-5 py-4 shadow-2xl shadow-black/30 backdrop-blur-xl [animation-delay:60ms] [animation-fill-mode:both]">
          <div className="flex items-center gap-3">
            <PulseDot />
            <h1 className="text-2xl font-black text-[#00ff88]">YieldMind</h1>
          </div>
